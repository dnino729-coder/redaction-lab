...
// LearningTaskStatus para no permitir mezclar estados entre entidades distintas.
...
export type LearningTaskStatus = (typeof LearningTaskStatus)[keyof typeof LearningTaskStatus];
