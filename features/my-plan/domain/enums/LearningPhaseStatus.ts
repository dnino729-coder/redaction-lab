...
// LearningPhaseStatus para no permitir mezclar estados entre entidades distintas.
// Vocabulario reutilizado de ExamAttemptStatus/LearningPlanStatus (18.21).
export const LearningPhaseStatus = {
...
export type LearningPhaseStatus = (typeof LearningPhaseStatus)[keyof typeof LearningPhaseStatus];
