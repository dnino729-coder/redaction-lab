# RÉDACTION LAB — ARCHITECTURE CHANGE MANAGEMENT STANDARD v1.2
...
| 1.2 | 2026-08-02 | Auditoría Final de Congelación de v1.1 (hallazgos C-01 a C-06) | **C-01:** revertidas íntegramente VALIDACIÓN FINAL y RESULTADO a su texto original de v1.0; eliminada por completo la sección "Riesgos abiertos" (no autorizada). **C-02:** este Historial de cambios corregido para reflejar exactamente las modificaciones reales. **C-03:** añadida a §6.1 la decisión explícita de que no existe límite temporal entre Divulgación y Solicitud de Regularización. **C-04:** añadida a §11 la declaración expresa de que la calificación del criterio de rechazo automático rige exclusivamente hacia adelante y no reabre ningún ACP ya decidido, incluido explícitamente el rechazo ya emitido a ACP-006 v1.1. **C-05:** verificado que los siete riesgos de ACP-008 permanecen íntegros en su fuente autorizada (ACP-008, campo "Riesgos", documento FROZEN y no modificado) — no se reintrodujo ninguna sección de riesgos en el Standard, por no existir alcance autorizado para ello. **C-06:** añadida a §10.1 una frase documentando que la configuración de evaluación dual resuelve, sin simplificarla, una de las dos alternativas que ACP-008 dejaba abiertas. Ninguna decisión ya aprobada por ACP-008 fue modificada; ninguna sección fuera de §6.1, §10.1, §11 y este mismo encabezado fue tocada respecto de v1.1. |
...
- Propone o asume que un documento Frozen ya fue modificado directamente, sin pasar por este proceso — **salvo que el ACP sea de Tipo Regularización (§4) y cumpla estrictamente las condiciones del Flujo de Regularización Retroactiva (§6.1): divulgación voluntaria previa a cualquier auditoría externa, anexo de Comparación Línea por Línea completo y verificable, y ausencia de cualquier otro criterio de rechazo automático de esta misma Sección.** Esta excepción es exclusiva de ese supuesto exacto; **no se extiende, bajo ninguna interpretación, a modificaciones no divulgadas o descubiertas sin declaración previa del equipo responsable**, que permanecen sujetas a rechazo automático sin excepción. **Esta excepción rige exclusivamente para hechos posteriores a la entrada en vigor de esta calificación (v1.2 de este Standard); no reabre, reinterpreta ni valida retroactivamente ningún ACP ya decidido bajo el texto anterior del presente criterio — incluyendo, sin limitarse a, el rechazo ya emitido por el Architecture Review Board a ACP-006 v1.1, que permanece firme y no queda sujeto a revisión por esta calificación.**
