# RÉDACTION LAB — ARCHITECTURE CHANGE MANAGEMENT STANDARD v1.5
...
| 1.5 | 2026-08-02 | Auditoría de Cierre de v1.4 (hallazgos C-12, C-13) | **C-12:** el paso 5 de §6 fue corregido para incluir `APROBADO PARCIALMENTE` en la enumeración de veredictos posibles, con una nota aclaratoria de que ese valor es exclusivo de ACP de Tipo Regularización (§6.1) — corrección mínima, sin alterar el funcionamiento del flujo normal ni introducir reglas nuevas. **C-13:** este mismo Historial de cambios fue actualizado para reflejar con precisión dicha corrección. Ninguna otra sección fue modificada; ningún mecanismo, board, estado documental o riesgo fue alterado; ninguna decisión de ACP-008 fue cambiada; ACP-006 v1.1 no fue reinterpretado. |
