# RÉDACTION LAB — ARCHITECTURE CHANGE MANAGEMENT STANDARD v1.0

**Emisor:** Architecture Change Control Board (ACCB), Rédaction Lab.
**Estado:** FROZEN desde su adopción (Sección "Resultado").
**Fecha:** 2026-07-19.
**Alcance de este documento:** define exclusivamente el proceso de gestión de cambios. No modifica ningún documento existente. No aplica ningún cambio. El caso práctico (Sección 14) es un ejemplo formal de uso del estándar, no una ejecución.
...
- Propone o asume que un documento Frozen ya fue modificado directamente, sin pasar por este proceso.
