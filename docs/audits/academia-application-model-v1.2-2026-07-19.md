# Academia Application Model v1.2
...
- Profesor: solo puede invocar `ApplyTeacherOverride`/`AssignUnitToStudent`/consultar `GetStudentProgressSummary` (incluida la invocación repetida por selección múltiple, *v1.2, ACP-002-B*) sobre estudiantes con relación docente ya establecida — mecanismo exacto de verificación de esa relación: **PENDIENTE DE DECISIÓN DE ARQUITECTURA** (pertenece al dominio de Organización Académica, §13.3, no a Academia).
