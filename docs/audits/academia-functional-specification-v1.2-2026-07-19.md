...
**Estado:** FROZEN
**Documentos dependientes:** `academia-architectural-resolutions-v1.0-2026-07-19.md` (A-01 a A-10), `academia-domain-model-v1.1-2026-07-19.md` (Frozen), `academia-application-model-v1.1-2026-07-19.md`, `academia-domain-vs-application-audit-2026-07-19.md` (Change Proposal CH-01), `academia-arb-resoluciones-pendientes-2026-07-19.md` (Resolución ARB de los cinco pendientes funcionales), `redaction-lab-architecture-change-management-standard-v1.0-2026-07-19.md` (ACP-001-B, ACP-001-C).
...
**Estado:** FROZEN
**Versión congelada:** 1.2
**Fecha de congelación:** 2026-07-19
**Versión anterior (1.1):** pasa a estado `SUPERSEDED`.
