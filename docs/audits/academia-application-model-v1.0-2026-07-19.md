# Academia Application Model v1.0

**Contrato de dominio congelado (no modificado):** `docs/audits/academia-domain-model-v1.1-2026-07-19.md`. **Fecha:** 2026-07-19.
...
|---|---|---|---|
| Cambios dentro de un único `Attempt` (CMD-02 a CMD-06) | Atómica (una transacción por Aggregate `Attempt`) | Fuerte, dentro del propio agregado | Sí, tras commit exitoso |
