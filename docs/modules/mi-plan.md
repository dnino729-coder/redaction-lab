...
- **Mi Plan → Perfil:** lectura única (`LearningPreference`, `StudentProfile.target_exam_date`) en el momento de creación del plan — sin sincronización posterior (Vacío 6).
